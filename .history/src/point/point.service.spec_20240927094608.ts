...
describe('PointService', () => {
  ...
  describe('Concurrency control', () => {
    ...
    it('multiple charge same user ID', async () => {
        ...
        expect(userTable.selectById).toHaveBeenCalledTimes(9); // 3 charges, each calling selectById twice
    ...
    it('multiple use same user ID', async () => {
        ...
        expect(userTable.selectById).toHaveBeenCalledTimes(9); // 3 uses, each calling selectById twice
        expect(userTable.insertOrUpdate).toHaveBeenCalledTimes(3); // Only three insertOrUpdate calls
